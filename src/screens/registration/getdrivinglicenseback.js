...
import { Text, View, ScrollView, Modal, Pressable, Image, TouchableOpacity, PermissionsAndroid, Alert, BackHandler, ActivityIndicator, SafeAreaView } from 'react-native';
...
const DrivinglicensebackScreen = ({ navigation }) => {
    ...
    const handlesubmitform = async () => {
        ...
        if (resourcePath.mime === undefined) {
            ...
            uploadData.append('customerProof', { type: resourcePath.mime, uri: resourcePath.path, name: resourcePath.path.split("/").pop() });

            const headers = {
                'Content-Type': 'multipart/form-data;charset=utf-8',
                'Access-Control-Allow-Origin': '*'
            }
            axiosInstance.post('mobile_registartion/license_back/', uploadData, { headers: headers })
                .then((res) => {
        ...
        <SafeAreaView style={styles.body}>
            ...
            >
                ...
                <View style={[styles.formgroup, styles.mT_02, styles.mB_0]}>
                    <Text style={[styles.textlable, styles.fc_brown, styles.mB_0, styles.pb_02]}>Upload front and back of driving license</Text>
                </View>

                <Text style={[styles.text_center, styles.fs_30, styles.fc_brown, styles.mB_015, styles.mT_01]}>BACK</Text>
                ...
                }
                {
                    imageuploaderror !== '' ?
                        <>
                            <Text style={[styles.textlable, styles.errortext, styles.pb_02]}>{imageuploaderror}</Text>
                        </>
                        :
                        <Text style={[styles.textlable, styles.errortext, styles.pb_02]}>{''}</Text>
                }

                <Pressable style={[styles.propic, styles.mT_02]} onPress={() => requestCameraPermission()}>
                    <View style={styles.btnupload_c}>
                        <Text style={[styles.mT_038, styles.text_center, styles.fs_22]}>CAPTURE</Text>
                    </View>
                </Pressable>
                ...
                <View style={[styles.container, modalBackgroundStyle]}>
                    <View style={[innerContainerTransparentStyle, styles.modal_body]}>
                        <View style={styles.modal_body_cnt}>
                            <Text style={[styles.modal_body_txt, styles.fc_brown]}>We have sent a link to your email. Please click on the link to confirm your email</Text>
