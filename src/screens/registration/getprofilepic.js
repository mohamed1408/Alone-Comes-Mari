...
const ProfilepicScreen = ({ navigation }) => {
    ...
    const handlesubmitform = async () => {
        ...
        if (resourcePath.mime === undefined) {
            ...
            uploadData.append('customerimg', { type: resourcePath.mime, uri: resourcePath.path, name: resourcePath.path.split("/").pop() });

            const headers = {
                'Content-Type': 'multipart/form-data;charset=utf-8',
                'Access-Control-Allow-Origin': '*'
            }
            axiosInstance.post('mobile_registartion/img/', uploadData, { headers: headers })
                .then((res) => {
    ...
    return (
        <SafeAreaView style={styles.body}>
            ...
            >
                ...
                <View style={[styles.headerlable]}>
                    <Text style={[styles.headerlabletext, styles.mB_06, styles.ls_0]}>Add a Groovy Picture of You</Text>
                </View>

                {resourcePath.path !== undefined ?
                    <TouchableOpacity style={styles.propic} onPress={requestCameraPermission}>
                        <Image
                ...
                }
                {
                    imageuploaderror !== '' ?
                        <>
                            <Text style={[styles.text_center, styles.errortext, styles.mT_03]}>{imageuploaderror}</Text>
                        </>
                        :
                        <Text style={[styles.text_center, styles.errortext, styles.pb_02]}>{''}</Text>
                }
