...
const OtpScreen = ({ navigation }) => {
    ...
    const handlesubmitform = async () => {
        ...
        if (validate) {
            ...
            axiosInstance.post('mobile_registartion/insert/', registerdata)
                .then((res) => {
                    if (res.data.status === 201) {
                ...
                <View style={[styles.container, modalBackgroundStyle, styles.mymodal_cont]}>
                    <View style={[innerContainerTransparentStyle, styles.modal_body]}>
                        <View style={[styles.modal_body_cnt, styles.mT_03]}>
                            <Text style={[styles.modal_body_txt, styles.text_center, styles.fc_brown]}>We have sent a link to your email. Please click on the link to confirm your email</Text>
